		...
		while((pilihan <= 4)&&(pilihan >= 1))
		{
			...
			else if(pilihan == 3)
			{
				...
				while((!lanjut_iterasi(MultiArray,nextArray))){
					// if(lanjut_iterasi(MultiArray,nextGeneration(MultiArray,nextArray))){
					// 	printf("Dua generasi sel yang saling menggantikan satu sama lainnya :\n\n");
					// 	showArray(MultiArray);
					// 	showArray(nextArray);
					// 	printf("\n\nTidak ada generasi terakhir sel satu-satunya\n.");
					// }
					//else{
