	...
	while(finish==0)
	{
		...
		while((pilihan <= 4)&&(pilihan >= 1))
		{
			...
			else
			{
				...
				//Kasus apabila input user salah (bukan Y/y/N/n)
				while((lanjutmain != 'Y')&&(lanjutmain != 'y')&&(lanjutmain != 'N')&&(lanjutmain != 'n'))
				{
					printf("Input salah. Silahkan jawab ulang sesuai dengan ketentuan yang tertera diatas.\n");
					printf("Jawab : ");
					scanf("%s",&lanjutmain);
				};
